<?php
/**
 * This file contains the Facebook Ignited library
 *
 * @package    FacebookIgnited
 * @subpackage Library
 * @license    https://raw.github.com/DarkProspectGames/Facebook-Ignited/master/license.txt New BSD License
 * @author     Alfonso E Martinez, III <corrupted.rogues@gmail.com>
 */
if (!defined('BASEPATH'))
...
class Fb_ignited {
    ...
    /**
     * this variable holds all of the global settings for Facebook Ignited
     * @var array
     */
    private $globals;
    /**
     * this variable holds the Facebook user's id
     * @var numeric
     */
	public $userid;
    /**
     * this holds the instance of the Facebook PHP SDK
     */
    private $facebook;
     ...
     * to it.
     *
     * @param mixed $script   determines if the user will be redirected
     * @param mixed $redirect determines if a header or javascript redirect occurs
     *
     * @return mixed
     * @throws FBIgnitedException
     */
    ...
    /**
     * Posts to Feed via Dialog
     *
     * This function will generate a post to feed dialog
     *
     * @deprecated 1.3.2
     * @todo remove this because we don't want JavaScript SDK in the PHP Class
     *
     * @param mixed $display
     * @param mixed $link
     * @param mixed $picture
